...
<div class="w-80 mt-5">
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-3 col-lg-3 ">
            ...
            <div class="card">
                <div class="card-header bg-dark text-white">All Brands</div>
                @foreach ($brand as $c )
                <a href="{{('/product?brand='.$c->slug)}}">
                    <li class="list-group-item">
                        {{$c->name}}
                    </li>
                </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4 text-center mt-2">
                            <a href="{{url('/product/'.$p->slug)}}">
                                <div class="card p-2">
                                    <img src="{{$p->image_url}}" alt="" class="img-fluid">
                                    <b>{{$p->name}}</b>
                                    <div>
                                        <small class=" badge badge-danger"> <strike>{{$p->sale_price}} ks</strike> </small>
