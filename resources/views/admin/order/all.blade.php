    ...
    <tbody>
        @foreach ($order as $o)
            <tr>
                ...
                <td>{{$o->product->discount_price}}</td>
                <td>
                    @if ($o->status==='success')
                ...
                <td>
                    <table class="table border">
                        ...
                        <tr>
                            <td><img src="{{$o->user->image_url}}" width="40" alt=""></td>
                            <td>{{$o->user->name}}</td>
                            <td>{{$o->user->phone}}</td>
                ...
                <td>
                    <a href="{{url('/admin/change-order?id='.$o->id.'&status=success')}}" class="btn btn-success">Success</a>
                    @if($o->status!=='success')
                    <a href="{{url('/admin/change-order?id='.$o->id.'&status=cancel')}}" class="btn btn-danger">Cancel</a>
                    @endif
